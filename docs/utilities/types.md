...
Fields: `type`, `code`, `guild_id`, `channel_id`, `guild`, `channel`, `inviter`, `target_type`, `target_user`, `target_application`, `approximate_presence_count`, `approximate_member_count`, `expires_at`, `guild_scheduled_event`, `roles`, `uses`, `max_uses`, `max_age`, `temporary`, `created_at`, `role_ids`, `flags`.
